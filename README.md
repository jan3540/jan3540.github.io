...
[![GitHub stars](https://img.shields.io/github/stars/TMaize/tmaize-blog?style=social)](https://github.com/jan3540)

一款 jekyll 主题（[GitHub 地址](https://github.com/jan3540)），简洁纯净(主题资源请求<20KB)，未引入任何框架，秒开页面，支持自适应，支持全文检索，支持夜间模式

你可以到 [Jan Blog](https://github.jan3540.io)查看主题效果 ，欢迎添加友链
